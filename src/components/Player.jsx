...
const Player = ({
  ...
  return (
    <motion.div
      ...
      className={`p-4 ${theme === 'dark' ? 'bg-gray-900/80' : 'bg-white/80'} backdrop-blur-md shadow-lg border-t ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'} flex flex-col gap-4 resize overflow-hidden`}
